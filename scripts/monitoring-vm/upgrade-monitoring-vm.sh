...
Usage:
  ...
  scripts/monitoring-vm/upgrade-monitoring-vm.sh check-upgrade-readiness
  scripts/monitoring-vm/upgrade-monitoring-vm.sh create-pre-upgrade-backup
  scripts/monitoring-vm/upgrade-monitoring-vm.sh dry-activate-monitoring-vm
  scripts/monitoring-vm/upgrade-monitoring-vm.sh deploy-monitoring-vm
  scripts/monitoring-vm/upgrade-monitoring-vm.sh verify-monitoring-vm

This orchestrates a safe monitoring-vm upgrade for the current repo state. It
...
phase_create_pre_upgrade_backup() {
  "$ROOT/scripts/monitoring-vm/create-monitoring-backup.sh"
}
...
run_all() {
  ...
  printf '\nmonitoring-vm upgrade completed.\n'
}
