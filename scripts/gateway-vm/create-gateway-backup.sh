...
for unit in traefik.service podman-gluetun-webui.service podman-gluetun.service podman-netbootxyz.service technitium-dns-server.service tailscaled.service netbird.service; do
