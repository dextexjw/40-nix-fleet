...
- `testbed-vm` runs Homebox, Kaneo, Listmonk, Plane, Sure, and Mailpit SMTP capture with appdata backups.
...
| `testbed-vm` | `10.2.20.129` | `testbed` | Homebox inventory testbed, Kaneo and Plane project-management testbeds, Listmonk newsletter testbed, Sure personal-finance testbed, Mailpit local and homelab SMTP capture, Restic appdata backups | [`hosts/testbed-vm/README.md`](hosts/testbed-vm/README.md) |
...
- `modules/testbed/`: the `testbed-vm` Homebox, Kaneo, Listmonk, Plane, Sure, Mailpit, PostgreSQL, backups, and recovery notes.
...
- [`hosts/testbed-vm/README.md`](hosts/testbed-vm/README.md): Homebox, Kaneo, Listmonk, Sure URLs, Mailpit capture, appdata paths, secrets, bootstrap, upgrade, backup, restore, and validation.
