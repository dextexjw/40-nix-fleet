...
- `productivity-vm` runs AFFiNE, Git forges, docs, documents, RSS, search, vault, file sync, finance, cloud files, speed tests, remote desktop relay, notes, short links, S3-compatible object storage, netboot.xyz, and appdata backups.
...
| `productivity-vm` | `10.2.20.114` | `productivity` | AFFiNE, productivity services, documents, Git forges, speed tests, remote desktop relay, notes, short links, object storage, netboot, Restic appdata backups | [`hosts/productivity-vm/README.md`](hosts/productivity-vm/README.md) |
